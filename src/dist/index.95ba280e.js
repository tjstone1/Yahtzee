...
})({"kiCJ3":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b66b3db495ba280e";
"use strict";
...
},{}],"9fDFb":[function(require,module,exports) {
var Refresh = require("16d2f41296177f35");
var ErrorOverlay = require("f90b20c1879c6409");
...
},{"16d2f41296177f35":"8iBTL","f90b20c1879c6409":"bg04Q"}],"8iBTL":[function(require,module,exports) {
"use strict";
module.exports = require("c764dc2b6072d967");

},{"c764dc2b6072d967":"8aTaJ"}],"8aTaJ":[function(require,module,exports) {
...
},{}],"bg04Q":[function(require,module,exports) {
var process = require("62fa7382a92485da");
!function(e, t) {
    module.exports = t();
}(window, function() {
    return function(e) {
...
},{"62fa7382a92485da":"d5jf4"}],"d5jf4":[function(require,module,exports) {
...
function isConsecutive(scores, length) {
    if (scores.length < length) return false;
    if (scores.every((value, index)=>value === index + 1) || scores.every((value, index)=>value === index + 2)) return true;
    return false;
}
function sum(scores) {
...
function clearPreviews(scores) {
    for (const value of scores)value.innerText = "";
    previewValues = [];
}
...
function checkScores(scores) {
    ...
    smallStraight = isConsecutive(uniqueValues.sort().slice(0, 4), 4) || isConsecutive(uniqueValues.sort().slice(1, 5), 4) ? 30 : 0;
...
diceElements.forEach((die, index)=>die.addEventListener("click", ()=>handleToggleLock(index)));
...
function firstExpectation(entry, rollResult) {
    ...
    switchCase: switch(entry.key){
        ...
        case "yahtzee":
            let max = 0;
            let maxn = 0;
            const multiplier = entry.key === "threeOAK" ? 3 : entry.key === "fourOAK" ? 4 : 5;
...
//# sourceMappingURL=index.95ba280e.js.map
